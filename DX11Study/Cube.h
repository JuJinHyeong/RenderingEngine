...
class Cube {
public:
	static IndexedTriangleList Make(std::optional<custom::VertexLayout> layout = {}) {
		using namespace custom;
		using Type = custom::VertexLayout::ElementType;

		if (!layout) {
			layout = custom::VertexLayout{};
	...
	static IndexedTriangleList MakeIndependent(custom::VertexLayout layout) {
		using namespace custom;
		using Type = custom::VertexLayout::ElementType;
	...
	static IndexedTriangleList MakeIndependentTextured() {
		using namespace custom;
		using ElementType = custom::VertexLayout::ElementType;
